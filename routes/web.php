...
Route::get('/article/{id}', [ArticleController::class, 'show'])->name('article')->whereNumber('id');
Route::get('/tag/{id}', [TagController::class, 'show'])->name('articlesByTag')->whereNumber('id');
Route::get('/article-category/{id}', [ArticleCategoryController::class, 'show'])
    ->name('articlesByCategory')->whereNumber('id');
...
Route::get('/menu/{slug}', [CategoryController::class, 'show'])->name('category')->whereAlpha('slug');
Route::get('/item/{id}', [ProductController::class, 'show'])->name('product')->whereNumber('id');
